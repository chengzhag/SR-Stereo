...
# experiment settings
pretrained_Stereo2_carla=logs/experiments/pretrain_Stereo1_Stereo2/Stereo_train/190312090325_PSMNetDown_loadScale_1.0_0.5_trainCrop_128_1024_batchSize_12_lossWeights_0.8_0.2_carla_kitti
...
pretrained_SR_carla=logs/experiments/SR_SRdisp_compare_carla/SR_train/190312090137_SR_loadScale_1_0.5_trainCrop_96_1360_batchSize_4_lossWeights_1_carla_kitti
pretrained_SRdisp_carla=logs/experiments/SR_SRdisp_compare_carla/SR_train/190312090240_SRdisp_loadScale_1_0.5_trainCrop_96_1360_batchSize_4_lossWeights_1_carla_kitti
...
## finetune SRdispStereoRefine using same parameters with SRStereo_Stereo1_compare_carla (TODO: train again with SR pretrain under half precision)
...
#PYTHONPATH=./ python evaluation/Stereo_eval.py  --model SRdispStereoRefine --dispscale 2 --outputFolder experiments/SRdispStereoRefine_SRStereo_compare_carla --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --eval_fcn outlier --itRefine 2 --batchsize_test $nGPUs --loadmodel logs/experiments/SRdispStereoRefine_SRStereo_compare_carla/Stereo_train/190311180844_SRdispStereoRefine_loadScale_1.0_0.5_trainCrop_128_1024_batchSize_12_lossWeights_0.5_0.4_0.1_carla_kitti --half
