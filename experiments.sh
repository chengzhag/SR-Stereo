...
pretrained_SR_carla=${experiment_dir}/SR_SRdisp_compare_carla/SR_train/190313084045_SR_loadScale_1_0.5_trainCrop_64_2040_batchSize_16_lossWeights_1_carla_kitti
...
## prepare: pretrain_SR_SRdisp_carla (DOING)
