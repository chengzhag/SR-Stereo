...
carla_kitti_dataset_module_test=../datasets/carla_kitti/carla_kitti_sr_lowquality_moduletest
...
# test: Stereo2_lossWeights_test (DOWN)
...
#PYTHONPATH=./ python train/Stereo_train.py --model PSMNet --dispscale 1 --outputFolder experiments/Stereo1_Stereo2_compare_test --datapath $carla_kitti_dataset --dataset carla_kitti  --trainCrop 128 1024 --epochs 10 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.001 2 0.0002 6 0.0001 --loadmodel logs/experiments/Stereo1_Stereo2_compare_test/Stereo_train/190303115921_PSMNet_loadScale_0.5_trainCrop_128_1024_batchSize_4_lossWeights_1_carla_kitti --load_scale 0.5 --resume
#PYTHONPATH=./ python train/Stereo_train.py --model PSMNetDown --dispscale 2 --outputFolder experiments/Stereo1_Stereo2_compare_test --datapath $carla_kitti_dataset --dataset carla_kitti  --trainCrop 128 1024 --epochs 10 --log_every 50 --test_every -1 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.001 2 0.0002 6 0.0001 --lossWeights 0.75 0.25 --loadmodel logs/experiments/Stereo2_lossWeights_test/Stereo_train/190304222730_PSMNetDown_loadScale_1.0_0.5_trainCrop_128_1024_batchSize_4_lossWeights_0.8_0.2_carla_kitti --load_scale 1 0.5 --resume
## step 2: evaluation
...
#PYTHONPATH=./ python train/SR_train.py  --model SR --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.00002 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint

## should have the same behaviour as seperate model
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.00002 --lossWeights 1 0 0 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.0002 --lossWeights 0 0.75 0.25 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint

# try to overfit few images
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset_module_test --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 5000 --log_every 10 --test_every -1 --save_every 100 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.0001 --lossWeights 0.06 0.705 0.235 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset_module_test --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 10000 --log_every 50 --test_every -1 --save_every 100 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.0001 --lossWeights 0.06 0.705 0.235 --loadmodel logs/experiments/SRStereo_lossWeights_test/Stereo_train/190305185554_SRStereo_loadScale_1.0_0.5_trainCrop_128_1024_batchSize_4_lossWeights_0.1_0.7_0.2_carla_kitti --resume

## step 2: training
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.0001 --lossWeights 0.06 0.47 0.47 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.0001 --lossWeights 0.1 0.45 0.45 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.0001 --lossWeights 0.16 0.42 0.42 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.0005 --lossWeights 0.06 0.47 0.47 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint
...
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.0002 --lossWeights 0.03 0.7275 0.2425 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.0002 --lossWeights 0.06 0.705 0.235 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.0002 --lossWeights 0.1 0.675 0.225 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.00005 --lossWeights 0.03 0.7275 0.2425 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.00005 --lossWeights 0.06 0.705 0.235 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint
#PYTHONPATH=./ python train/Stereo_train.py  --model SRStereo --dispscale 2 --outputFolder experiments/SRStereo_lossWeights_test --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 1 0.5 --trainCrop 128 1024 --epochs 1 --log_every 50 --test_every 0 --batchsize_train 4 --batchsize_test $nGPUs --lr 0.00005 --lossWeights 0.1 0.675 0.225 --loadmodel $SRStereo_lossWeights_test_SR_checkpoint $SRStereo_lossWeights_test_Stereo_checkpoint
