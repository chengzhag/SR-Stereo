...
#PYTHONPATH=./ python train/Stereo_train.py  --model PSMNet --dispscale 1 --outputFolder experiments/SRStereo_finetune_kitti2015 --datapath $kitti2015_dataset --dataset kitti2015 --load_scale 1 --trainCrop 256 512 --epochs 300 --log_every 50 --test_every 10 --batchsize_train 12 --batchsize_test $nGPUs --lr 0.001 200 0.0001 --loadmodel logs/experiments/SRStereo_finetune_kitti2015/Stereo_train/190307085805_PSMNet_loadScale_1.0_trainCrop_256_512_batchSize_12_lossWeights_1_kitti2015 --resume
