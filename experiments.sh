...
## step 2: evaluation
#CUDA_VISIBLE_DEVICES=1,2,3 PYTHONPATH=./ python evaluation/Stereo_eval.py --model PSMNetDown --maxdisp 384 --dispscale 2 --datapath $carla_kitti_dataset --dataset carla_kitti --batchsize_test 3 --eval_fcn outlier --half --loadmodel logs/experiments/Stereo1_Stereo2_compare_test/Stereo_train/190227152726_PSMNet_loadScale_10_trainCrop_128_1024_batchSize_4_carla_kitti/checkpoint_epoch_0005_it_01000.tar --load_scale 1 0.5
CUDA_VISIBLE_DEVICES=1,2,3 PYTHONPATH=./ python evaluation/Stereo_eval.py --model PSMNet --maxdisp 192 --dispscale 1 --datapath $carla_kitti_dataset --dataset carla_kitti --batchsize_test 3 --eval_fcn outlier --half --loadmodel logs/experiments/Stereo1_Stereo2_compare_test/Stereo_train/190227125217_PSMNet_loadScale_5_trainCrop_128_1024_batchSize_4_carla_kitti/checkpoint_epoch_0005_it_01000.tar --load_scale 0.5
