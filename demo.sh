...
CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/SRdisp_train.py --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti --trainCrop 96 1360 --epochs 10 --log_every 50 --test_every 1 --eval_fcn l1 --batchsize_train 4 --batchsize_test 4  --lr 0.0001 --loadmodel logs/SRdisp_train/190224180753_SR_loadScale_10_trainCrop_96_1360_batchSize_4_carla_kitti/checkpoint_epoch_0005_it_01000.tar
#CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/SRdisp_train.py --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti --trainCrop 96 1360 --epochs 5 --log_every 50 --test_every 1 --eval_fcn l1 --batchsize_train 4 --batchsize_test 4  --lr 0.0002 1 0.0001 3 0.00005 --loadmodel logs/pretrained/EDSR_pretrained_DIV2K/EDSR_baseline_x2.pt
#CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/SR_train.py --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti --trainCrop 96 1360 --epochs 5 --log_every 50 --test_every 1 --eval_fcn l1 --batchsize_train 4 --batchsize_test 4  --lr 0.0002 1 0.0001 3 0.00005 --loadmodel logs/pretrained/EDSR_pretrained_DIV2K/EDSR_baseline_x2.pt
#CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/SRdisp_train.py --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti --trainCrop 96 1360 --epochs 5 --log_every 50 --test_every 1 --eval_fcn l1 --batchsize_train 4 --batchsize_test 4  --lr 0.0002 --loadmodel logs/pretrained/EDSR_pretrained_DIV2K/EDSR_baseline_x2.pt
...
#CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/SRdisp_train.py --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti --trainCrop 96 1360 --epochs 5 --log_every 50 --test_every 1 --eval_fcn l1 --batchsize_train 4 --batchsize_test 4  --lr 0.00005 --loadmodel logs/pretrained/EDSR_pretrained_DIV2K/EDSR_baseline_x2.pt

#for testing purpose
#full-scale PSMNet with same D dimension but different trainCrop trained with carla_kitti
#Fintune PSMNet with carla_kitti dataset:
CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/Stereo_train.py --maxdisp 384 --dispscale 2 --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti  --trainCrop 256 512 --epochs 3 --log_every 50 --test_every 1 --batchsize_train 4 --batchsize_test 2 --lr 0.001 1 0.0005 2 0.00001 --eval_fcn 6_outlier --loadmodel logs/pretrained/PSMNet_pretrained_sceneflow/PSMNet_pretrained_sceneflow.tar --half
CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/Stereo_train.py --maxdisp 384 --dispscale 2 --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti  --trainCrop 192 688 --epochs 3 --log_every 50 --test_every 1 --batchsize_train 4 --batchsize_test 2 --lr 0.001 1 0.0005 2 0.00001 --eval_fcn 6_outlier --loadmodel logs/pretrained/PSMNet_pretrained_sceneflow/PSMNet_pretrained_sceneflow.tar --half
CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/Stereo_train.py --maxdisp 384 --dispscale 2 --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti  --trainCrop 128 1024 --epochs 3 --log_every 50 --test_every 1 --batchsize_train 4 --batchsize_test 2 --lr 0.001 1 0.0005 2 0.00001 --eval_fcn 6_outlier --loadmodel logs/pretrained/PSMNet_pretrained_sceneflow/PSMNet_pretrained_sceneflow.tar --half
CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/Stereo_train.py --maxdisp 384 --dispscale 2 --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti  --trainCrop 96 1360 --epochs 3 --log_every 50 --test_every 1 --batchsize_train 4 --batchsize_test 2 --lr 0.001 1 0.0005 2 0.00001 --eval_fcn 6_outlier --loadmodel logs/pretrained/PSMNet_pretrained_sceneflow/PSMNet_pretrained_sceneflow.tar --half
CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/Stereo_train.py --maxdisp 384 --dispscale 2 --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti  --trainCrop 80 1632 --epochs 3 --log_every 50 --test_every 1 --batchsize_train 4 --batchsize_test 2 --lr 0.001 1 0.0005 2 0.00001 --eval_fcn 6_outlier --loadmodel logs/pretrained/PSMNet_pretrained_sceneflow/PSMNet_pretrained_sceneflow.tar --half

##for testing purpose
##full-scale EDSR with same settings with EDSR_baseline_x2 but different trainCrop
#CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/SR_train.py --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti  --trainCrop 256 512 --epochs 5 --log_every 50 --test_every 1 --eval_fcn l1 --batchsize_train 4 --batchsize_test 4 --lr 0.0001 1 0.00005 3 0.00002 --loadmodel logs/pretrained/EDSR_pretrained_DIV2K/EDSR_baseline_x2.pt
#CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/SR_train.py --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti  --trainCrop 192 688 --epochs 5 --log_every 50 --test_every 1 --eval_fcn l1 --batchsize_train 4 --batchsize_test 4 --lr 0.0001 1 0.00005 3 0.00002 --loadmodel logs/pretrained/EDSR_pretrained_DIV2K/EDSR_baseline_x2.pt
#CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/SR_train.py --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti  --trainCrop 128 1024 --epochs 5 --log_every 50 --test_every 1 --eval_fcn l1 --batchsize_train 4 --batchsize_test 4 --lr 0.0001 1 0.00005 3 0.00002 --loadmodel logs/pretrained/EDSR_pretrained_DIV2K/EDSR_baseline_x2.pt
#CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/SR_train.py --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti  --trainCrop 96 1360 --epochs 5 --log_every 50 --test_every 1 --eval_fcn l1 --batchsize_train 4 --batchsize_test 4 --lr 0.0001 1 0.00005 3 0.00002 --loadmodel logs/pretrained/EDSR_pretrained_DIV2K/EDSR_baseline_x2.pt
#CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./ python train/SR_train.py --datapath ../datasets/carla_kitti/carla_kitti_sr_lowquality --dataset carla_kitti  --trainCrop 80 1632 --epochs 5 --log_every 50 --test_every 1 --eval_fcn l1 --batchsize_train 4 --batchsize_test 4 --lr 0.0001 1 0.00005 3 0.00002 --loadmodel logs/pretrained/EDSR_pretrained_DIV2K/EDSR_baseline_x2.pt
