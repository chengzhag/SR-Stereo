...
PYTHONPATH=./ python train/Stereo_train.py --outputFolder moduletests --maxdisp 96 --dispscale 0.5 --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 0.25 --trainCrop 128 256 --epochs 3 --log_every 1 --test_every 1  --eval_fcn outlier --batchsize_train 4 --batchsize_test 2 --lr 0.001 --loadmodel logs/pretrained/PSMNet_pretrained_sceneflow/PSMNet_pretrained_sceneflow.tar

# test SR_train/eval with EDSR
echo 'SR_train/eval with EDSR'
PYTHONPATH=./ python train/SR_train.py --outputFolder moduletests --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 0.5 --trainCrop 128 256 --epochs 5 --log_every 1 --test_every 1 --eval_fcn l1 --batchsize_train 4 --batchsize_test 2  --lr 0.0001 --loadmodel logs/pretrained/EDSR_pretrained_DIV2K/EDSR_baseline_x2.pt

# test SRdisp_train/eval with EDSR
echo 'test SRdisp_train/eval with EDSR'
PYTHONPATH=./ python train/SRdisp_train.py --outputFolder moduletests --datapath $carla_kitti_dataset --dataset carla_kitti --load_scale 0.5 --trainCrop 128 256 --epochs 5 --log_every 1 --test_every 1 --eval_fcn l1 --batchsize_train 4 --batchsize_test 2  --lr 0.0001 --loadmodel logs/pretrained/EDSR_pretrained_DIV2K/EDSR_baseline_x2.pt
